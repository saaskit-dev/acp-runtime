...
export type HarnessScenarioCategory = "main-flow" | "host-authority";
...
export type HarnessPermissionFamily =
  | "mode_denied"
...
export type HarnessAssertion =
  ...
  | { type: "transcript-has-tool-kind"; kind: string }
  | { type: "transcript-has-tool-update"; kind: string; status?: string }
  ...
  /** Passes when any nested assertion passes. */
  | { type: "any-of"; assertions: HarnessAssertion[] };
...
export type HarnessDiscoverySummary = {
  ...
  permission?: {
    deniedFamilies?: HarnessPermissionFamily[];
